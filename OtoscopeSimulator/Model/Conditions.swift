...
struct Conditions {
    ...
    static let TympanicMembranePerforation = Condition(name: "Traumatic Tympanic Membrane Perforation", thumbnailName: "", imageName: "", testConditionName: ["Myringosclerosis", "Tympanic Membrane Perforation", "Haemotympanum", "Foreign Body"], informationText: "Tympanic membrane perforations can be caused by direct penetrating injury or from barotrauma - a sudden change in pressure.", signs:[])

    static let TraumaticTympanicMembranePerforation = Condition(name: "Tympanic Membrane Perforation", thumbnailName: "04_perforation_thumb.jpg", imageName: "04_perforation.jpg", testConditionName: ["Myringosclerosis", "Tympanic Membrane Perforation", "Haemotympanum", "Foreign Body"], informationText: "Tympanic membrane perforations can be caused by direct penetrating injury or from barotrauma - a sudden change in pressure.", signs:["Blood suggests trauma (1)","Perforation (2)"])

    static let OtitisExterna = Condition(name: "Otitis Externa", thumbnailName: "", imageName: "", testConditionName: [], informationText: "", signs: ["Tympanic membrane not visible", "Redness and swelling of ear canal", "Debris/discharge"])
    
    static let Grommet = Condition(name: "Grommet", thumbnailName: "", imageName: "", testConditionName: [], informationText: "", signs: ["A visible grommet"])
